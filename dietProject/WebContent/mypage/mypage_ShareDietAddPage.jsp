	...
	<article>
		<div class="article_container">
			<table style='min-width: 0px !important;' class="table table-borderless">
				<thead>
					<tr>
						<th colspan="3"><h5>담은 식단 관리 ${listcount}</h5></th> 
						<th colspan="2">
<!-- 							<button id="compDiet" type="button" class="btn btn-secondary">
				...
				<tbody>
								...
								<td>
	  							...
	  							<td colspan="2" style="text-align: right !important;">
									<s:if test="${b.diet_share == true}">
										<button style="visibility: hidden ! important;" class="btn btn-secondary" disabled>공유중</button>
									</s:if>
					...
					<s:if test="${listcount == 0 }">
						<tr><td colspan="5">담은 식단이 없습니다.</td></tr>
					</s:if>
				</tbody>
			</table>
			<s:if test="${listcount > 0 }">
	...
	<script type="text/javascript" src="js/shareDietAdd.js" charset="utf-8"></script>
